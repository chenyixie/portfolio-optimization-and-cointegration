#Portfolio optimization for synthetic data _ markowitz_normal_indep
...
# Plot density graphs
plot(final.density[[1]], type = 'l', col = '1', ylim = c(0,2), main = 'Estimated parameters', xlab = 'Expected Reward')
for (i in 2:8) {
...
#Plot density graphs
plot(final.true.density[[1]], type = 'l', col = '1', ylim = c(0,1.5),main = 'True parameters', xlab = 'Expected Reward')
for (i in 2:8) {
